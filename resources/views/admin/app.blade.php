  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.html">
        <a class="navbar-brand" href="/"><img src="{{ asset('img/Logo_Politeknik_Negeri_Jakarta.png')}}" alt="responsive" class="img-fluid"><span><img src="{{ asset('img/himatik.png')}}" alt="responsive" class="img-fluid"></span></a></a>
